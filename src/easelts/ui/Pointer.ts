...
// installing handjs
var enablePointerEventsOnElement = function(argElements:Array<HTMLElement>)
{
...
{
	public static enable(stage:Stage):boolean
	{
	 ...
	 * @private
	 */
	private static _enable(stage:Stage):void
	{
