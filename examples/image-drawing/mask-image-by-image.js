define(["require", "exports", '../../src/easelts/display/Stage', '../../src/easelts/display/Bitmap', '../../src/easelts/display/Container', "../../src/easelts/renderer/Canvas2DElement"], function (require, exports, Stage_1, Bitmap_1, Container_1, Canvas2DElement_1) {
    ...
    var container = new Container_1.default().setBuffer(new Canvas2DElement_1.Canvas2DElement(500, 500), true);
    ...
    var container = new Container_1.default().setBuffer(new Canvas2DElement_1.Canvas2DElement(500, 500));
